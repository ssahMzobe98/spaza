...
if(isset($_SESSION['user_agent'],$_SESSION['var_agent'])){
  ...
  if($cur_user_row['user_type']==Constants::USER_TYPE_ADMIN  || $cur_user_row['user_type']===Constants::USER_TYPE_SUPPLIER){
    if(isset($_GET['min'],$_GET['limit'])){
      ...
      $nav = "loadAfterQuery('.displayOrderData','../model/loadLiveOrdersPagination.php?min={$minLevel}&limit={$limitLevel}')";
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tfoot>
            <tr>
              <th><div class='button'>
                    <a onclick="loadAfterQuery('.displayOrderData','../model/loadLiveOrdersPagination.php?min=<?php echo $min;?>&limit=<?php echo $limit;?>');">prev</a>
                  </div>
              </th>
              <th></th>
              <th></th>
