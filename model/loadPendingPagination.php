...
if(isset($_SESSION['user_agent'],$_SESSION['var_agent'])){
  ...
  if($cur_user_row['user_type']==Constants::USER_TYPE_ADMIN){
    if(isset($_GET['min'],$_GET['limit'])){
      ...
      $nav = "loadAfterQuery('.displayOrderData','../model/loadPendingPagination.php?min={$minLevel}&limit={$limitLevel}')";
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tfoot>
            <tr>
              <th><div class='button'>
                    <a onclick="loadAfterQuery('.displayOrderData','../model/loadPendingPagination.php?min=<?php echo $min;?>&limit=<?php echo $limit;?>');">prev</a>
                  </div>
              </th>
              <th></th>
              <th></th>
